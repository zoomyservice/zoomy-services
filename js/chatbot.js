...
const CB_PRESETS = {
  restaurant:{name:'The Golden Fork',type:'Restaurant & Bar',tagline:'Modern European cuisine with seasonal ingredients, craft cocktails, and weekend brunch',services:['Dine-in lunch & dinner','Weekend brunch (Sat–Sun 10am–3pm)','Private dining & event buyouts','Takeout orders','Corporate catering'],hours:'Mon–Thu 11:30am–10pm, Fri–Sat 11:30am–11pm, Sun 10am–3pm (brunch only)',pricing:'Starters $10–18, Mains $24–48, Weekend brunch $16–28, Cocktails $13–18',menu:'Our menu rotates seasonally. Current starters include burrata with heirloom tomatoes, beef tartare, and roasted bone marrow. Mains feature pan-seared halibut, duck confit, house-made tagliatelle with truffle, and a dry-aged NY strip. Weekend brunch offers eggs Benedict, ricotta pancakes, smoked salmon bagels, and French pastries. Cocktails include craft negronis, seasonal spritzes, and an extensive wine list.',dietary:'We accommodate vegetarian, vegan, and gluten-free guests with dedicated menu options. We are not a kosher-certified or halal-certified kitchen, but our team can walk through ingredients for guests with specific needs. Allergens including nuts are flagged on the menu.',reservations:'Book online, call during hours, or walk in — we hold tables for walk-ins nightly.',location:'Downtown city center, 5 min from the central metro station'},
  gym:{name:'Peak Performance Fitness',type:'Gym & Fitness Studio',tagline:'Results-driven training for all levels — from first-timers to competitive athletes',services:['Full gym floor access','1-on-1 personal training','Group fitness classes (HIIT, yoga, spin)','Nutrition coaching','Sauna & cold plunge recovery'],hours:'Mon–Fri 5:30am–11pm, Sat–Sun 7am–9pm',pricing:'Basic $49/mo (gym only), Unlimited $79/mo (gym + all classes), PT from $129/mo. Day pass $15.',classes:'Group classes run throughout the day. Morning: HIIT bootcamp (6am, 7am), yoga flow (8am). Midday: spin (12pm), pilates (1pm). Evening: HIIT (5pm, 6pm, 7pm), yoga (7:30pm). Weekend: yoga, spin, and bootcamp at various times. Full schedule at the front desk.',equipment:'Full cardio floor with treadmills, ellipticals, rowers, and assault bikes. Free weight area with dumbbells up to 120lbs, barbells, squat racks, and cable machines. Functional training zone with kettlebells, TRX, and battle ropes.',trial:'Free 3-day trial pass — no credit card required. Sign up at the front desk or online.',cancellation:'Month-to-month; cancel with 15 days notice. No long-term contracts unless on annual plan.',facilities:'3 floors: cardio, free weights, group class studio. Locker rooms with showers and secure storage. Sauna and cold plunge on the third floor.',location:'Multiple city locations — main branch in the financial district'},
  salon:{name:'Luxe Beauty Studio',type:'Beauty Salon & Spa',tagline:'Where great hair, flawless skin, and total relaxation come together',services:['Haircuts & blow-dry styling','Balayage, highlights & color','Lash lifts & extensions','Facials & skin treatments','Manicure, pedicure & nail art'],hours:'Tue–Sat 9am–7pm, Sun 10am–5pm. Closed Mondays.',pricing:'Haircuts from $55, Balayage from $180, Lash extensions from $120, Facials from $85, Manicure from $35.',treatments:'Hair: cuts and blow-dry styling, balayage, highlights, full color, toning, Olaplex treatments, and keratin smoothing. Skin: hydrating facials, deep-cleanse facials, chemical peels, and LED therapy. Lashes: classic, volume, and mega-volume extensions; lash lifts and tints. Nails: gel manicures, dip powder, acrylics, pedicures, and nail art.',booking:'All appointments online or by phone. Book 1–2 weeks ahead for color. Same-day slots available for cuts.',cancellation:'Please cancel or reschedule 24h in advance to avoid a 50% late-cancellation fee.',products:'We use and retail Kerastase and Olaplex. Cruelty-free and vegan options available on request.',location:'Uptown, free parking in the building lot'},
  dental:{name:'Bright Smile Dental',type:'Dental Clinic',tagline:'Comfortable, modern dentistry for the whole family — gentle care from the first visit',services:['Routine cleanings & checkups','Teeth whitening','Invisalign clear aligners','Dental implants','Emergency same-day care','Pediatric dentistry'],hours:'Mon–Thu 8am–6pm, Fri 8am–3pm, Sat 9am–2pm (select dates)',pricing:'Cleaning from $120, Whitening $350, Invisalign consultation free, Implants from $2,200, Emergency visit from $100 (waived if proceeding with treatment).',treatments:'Preventive: cleanings, X-rays, fluoride, sealants. Cosmetic: in-office whitening, Invisalign, veneers. Restorative: fillings, crowns, bridges, dental implants. Emergency: same-day appointments for pain, broken teeth, lost fillings. Pediatric: gentle care for kids from first tooth through teens.',insurance:'We accept most major dental insurance plans and bill directly. 0% financing through CareCredit available.',anxiety:'We specialize in anxious patients. Nitrous oxide available, team trained to work at your pace.',location:'Inside the Westside Medical Plaza, validated parking available'},
  legal:{name:'Harrington & Associates',type:'Law Firm',tagline:'Straightforward legal guidance for individuals, families, and growing businesses',services:['Personal injury claims','Business contracts & formation','Real estate transactions','Family law & divorce','Estate planning & wills'],hours:'Mon–Fri 9am–6pm. Evening consultations available by appointment.',pricing:'Free 30-minute initial consultation for most cases. Personal injury on contingency (no win, no fee). Business law from $250/hr. Flat-fee packages for wills and real estate closings.',practice_areas:'Personal injury: car accidents, slip and fall, workplace injuries. Business: LLC/corp formation, contracts, partnership agreements, employment matters. Family law: divorce, child custody and support, prenuptial agreements. Real estate: closings, title review, lease disputes. Estate planning: wills, trusts, powers of attorney, probate.',process:'After your free consult we outline options and fees in writing before any engagement. No surprise billing.',location:'Financial district, 12th floor — elevator accessible, parking validated'},
  realestate:{name:'Crestview Realty',type:'Real Estate Agency',tagline:'Helping you buy, sell, or rent with confidence — local experts, honest advice',services:['Residential buying & selling','Rental property management','Commercial real estate','Free home valuations','Investor portfolio consulting'],hours:'Mon–Sat 9am–7pm, Sun by appointment',pricing:'Seller commission 5% (split with buyer agent). Rental management 8%/mo of collected rent. Home valuation always free.',what_we_do:'Buyers: we guide you from pre-approval through closing — finding listings that match your needs, negotiating offers, and managing the paperwork. Sellers: we price your home accurately, list it within 5 days with professional photography, and handle showings and negotiations. Investors: portfolio review, cap rate analysis, and property management. Rentals: tenant screening, lease management, maintenance coordination.',process:'Buyers: free strategy call, pre-approval guidance, property tours. Sellers: listed within 5 days, professional photos included.',contract:'Listing agreements 90 days. Buyer representation agreements are flexible.',location:'Full metro area with local offices in three neighborhoods'},
  store:{name:'Nomad Supply Co.',type:'Online Outdoor & Lifestyle Store',tagline:'Gear tested in the field, not just in marketing photos — built for people who actually go outside',services:['Outdoor apparel & footwear','Camping & hiking gear','Monthly subscription box','Gift cards'],hours:'Customer support Mon–Fri 9am–6pm EST. Orders ship 24/7.',pricing:'Apparel $35–$180, Gear $20–$400, Subscription box $49/mo. Free standard shipping on orders over $75.',catalog:'Apparel: hiking pants, moisture-wicking base layers, softshell jackets, rain gear, merino wool tees, trail running shorts, and waterproof boots. Gear: tents (2-person and 4-person), sleeping bags (down and synthetic), trekking poles, headlamps, water filters, camp stoves, cookware, and first aid kits. Subscription box: curated monthly selection of 4–6 items — mix of snacks, gear accessories, and apparel, themed around a different trail or destination each month.',cancellation:'Orders cannot be cancelled once placed as they go to fulfillment immediately. However you can return any unworn/unused item within 60 days for a full refund. Subscription boxes can be cancelled anytime before the next billing date.',returns:'60-day returns on unworn/unused items. If it breaks under normal field use, contact us — we stand behind our gear.',shipping:'Standard (3–5 days) free over $75, Express (1–2 days) $12. International shipping to 30+ countries.',loyalty:'Earn 1 point per $1 spent. 100 points = $5 off. Points never expire.',location:'Ships from Portland, OR — online only, no retail locations'},
  auto:{name:'ProTech Auto Repair',type:'Auto Repair Shop',tagline:'Honest repairs, fair prices, done right the first time — no upselling',services:['Oil changes & fluid services','Brake inspection & replacement','Transmission service & repair','Full diagnostics','Tire rotation & balancing','AC & heating repair'],hours:'Mon–Fri 7:30am–6pm, Sat 8am–3pm',pricing:'Oil change from $49, Brake pads from $120/axle, Diagnostics $75 (waived with repair), Tire rotation $25.',what_we_fix:'Engine & drivetrain: oil and fluid changes, belt and hose replacement, engine diagnostics, transmission service. Brakes: pad and rotor replacement, brake fluid flush, caliper service. Tires: rotation, balancing, flat repair. HVAC: AC recharge, heater core, compressor replacement. Electrical: battery, alternator, starter, check engine light diagnosis. Suspension: shocks, struts, alignment.',warranty:'All repairs include 12-month / 12,000-mile warranty on parts and labor.',process:'We show you what we find before doing any work — photos included. No repair starts without your approval.',location:'East side, 2 min off the highway. Free shuttle within 3 miles.'},
};
...
#zmy-presets{padding:6px 14px 8px;background:#0d0d1c;border-top:1px solid rgba(99,102,241,.12);flex-shrink:0}
#zmy-presets-lbl{font-size:.68rem;color:#64748b;margin-bottom:5px}
#zmy-presets-grid{display:flex;flex-wrap:nowrap;gap:5px;overflow-x:auto;padding-bottom:2px;-webkit-overflow-scrolling:touch;scrollbar-width:none}
#zmy-presets-grid::-webkit-scrollbar{display:none}
.zmy-pb{background:#111128;border:1px solid rgba(99,102,241,.2);border-radius:20px;padding:.22rem .55rem;font-size:.7rem;color:#94a3b8;cursor:pointer;transition:all .15s;font-family:inherit;white-space:nowrap;line-height:1.5;flex-shrink:0}
...
.zmy-pb-intro{font-size:.68rem;color:#64748b;margin-bottom:5px}
.zmy-pb-grid{display:flex;flex-wrap:nowrap;gap:5px;overflow-x:auto;padding-bottom:2px;-webkit-overflow-scrolling:touch;scrollbar-width:none}
.zmy-pb-grid::-webkit-scrollbar{display:none}
